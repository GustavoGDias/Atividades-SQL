...
insert into pessoas (data_nascimento, genero, estado_civil, rg) values ('1990-01-01', 'Masculino', 'Solteiro', '123456789');
insert into pessoas (data_nascimento, genero, estado_civil, rg) values ('1985-02-15', 'Feminino', 'Casado', '987654321');
insert into pessoas (data_nascimento, genero, estado_civil, rg) values ('1978-06-30', 'Masculino', 'Divorciado', '456789123');
insert into pessoas (data_nascimento, genero, estado_civil, rg) values ('2000-10-20', 'Feminino', 'Solteiro', '321654987');
insert into pessoas (data_nascimento, genero, estado_civil, rg) values ('1995-12-25', 'Masculino', 'Casado', '654987321');
...
-- Telefones
insert into telefones (id_pessoa, ddd, telefone) values (1, 11, '123456789');
insert into telefones (id_pessoa, ddd, telefone) values (2, 11, '987654321');
insert into telefones (id_pessoa, ddd, telefone) values (3, 11, '456789123');
insert into telefones (id_pessoa, ddd, telefone) values (4, 11, '321654987');
insert into telefones (id_pessoa, ddd, telefone) values (5, 11, '654987321');
...
insert into enderecos (id_pessoa, logradouro, numero, cep, bairro, cidade, estado) values (5, 'Rua E', '500', '34567-890', 'Centro', 'Curitiba', 'PR');
...
insert into medicos (id_pessoa, crm) values (4, 'CRM-SP5667');
insert into medicos (id_pessoa, crm) values (5, 'CRM-SP5789');
...
insert into consultas (data, diagnostico, id_medico, id_paciente) values ('2024-02-28', 'Dor de cabeça', 2, 2);
...
-- Exames
insert into exames (id_consulta, data, exame) values (1, '2024-02-27', 'Raio-X de tórax');
insert into exames (id_consulta, data, exame) values (2, '2024-02-28', 'Ressonância magnética');
...
select * from consultas where id_medico = 1; -- Exemplo com o id 1

select * from exames where id_consulta = 1; -- Exemplo com o id 1

select * from telefones where id_pessoa = 1; -- Exemplo com o id 1
